...
export const MSG: Record<string, Entry> = {
  ...
  "nav.collab": { ko: "협진 (Co-Reading)", en: "Co-Reading", ru: "Совместный просмотр",
                  zh: "协同阅片", ja: "協働読影", es: "Co-lectura", de: "Gemeinsame Befundung",
                  fr: "Co-lecture", vi: "Hội chẩn", ar: "القراءة المشتركة" },
